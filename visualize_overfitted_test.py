...
def plot_samples_grid(alpha_vals, beta_vals, loss_grids, metas, save_path,
    ...
    plt.suptitle('CIFAR-100 Overfitted Model - Test Set Loss Landscapes (Filter-Normalized)',
...
def main():
    ...
    print("=" * 60)
    print("CIFAR-100 Overfitted Model - Test Set Single-Sample Landscapes")
    print("=" * 60)
    ...
    with open('loss_landscape_results/selected_samples_overfitted_test.json', 'w') as f:
        json.dump({
            'seed': SEED,
    ...
    print("   Saved: loss_landscape_results/selected_samples_overfitted_test.json")
    
    print("\n8. Creating visualization...")
    plot_samples_grid(
        alpha_vals, beta_vals, loss_grids, metas,
        'loss_landscape_results/samples_landscape_overfitted_test.png',
        layout=LAYOUT,
        share_colorbar=True,
    ...
    plot_samples_grid(
        alpha_vals, beta_vals, loss_grids, metas,
        'loss_landscape_results/samples_landscape_overfitted_test.pdf',
        layout=LAYOUT,
        share_colorbar=True,
        color_scale=COLOR_SCALE
    )
    ...
    for i, (idx, loss_grid) in enumerate(zip(selected_indices, loss_grids)):
        np.savez(f'loss_landscape_results/sample_{idx}_overfitted_test.npz',
                 alpha=alpha_vals,
                 beta=beta_vals,
                 loss=loss_grid,
                 idx=idx,
    ...
    with open('loss_landscape_results/overfitted_test_experiment_log.txt', 'w') as f:
        f.write("CIFAR-100 Overfitted Model - Test Set Landscapes\n")
        f.write("=" * 60 + "\n\n")
